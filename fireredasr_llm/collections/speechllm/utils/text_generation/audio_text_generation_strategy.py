...
class SpeechToTextGenerationStrategy(TextGenerationStrategy):
    ...
    def init_batch(
        ...
        (
            ...
            speech_features=audio_feats,
            input_ids=context_tokens,
            labels=context_tokens,
            speech_lens=audio_feat_lens,
        ...
        return final_labels, final_embedding, audio_feat_lens
    ...
    def prepare_batch_at_step(
        ...
        if step == 0:
            ...
            embeddings2use = input_embeddings[:curr_context_length-1].contiguous()
        ...
        if attention_mask is not None:
            attention_mask = attention_mask[:, :, :curr_context_length-1, :curr_context_length-1]
