...
from fireredasr_llm.collections.speechllm.data.audio_to_text_module import AudioToTextDataModule
from fireredasr_llm.collections.speechllm.models.speech_to_text_llm_model import SpeechToTextLLM, SpeechToTextLLMConfig
from fireredasr_llm.collections.speechllm.modules.asr_module import ASRModuleConfig
from fireredasr_llm.collections.speechllm.modules.modality_adapter import ModalityAdapterConfig
...
def build_components(cfg: DictConfig, tokenizer: Optional[AutoTokenizer] = None) -> PipelineComponents:
    ...
    tokenizer = LlmTokenizerWrapper.build_llm_tokenizer(cfg['model']['llm']['pretrained_model'])
