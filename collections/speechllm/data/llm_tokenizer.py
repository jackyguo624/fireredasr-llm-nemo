...
class LlmTokenizerWrapper:
    ...
    def preprocess_texts(cls, origin_texts, tokenizer, max_len, decode=False):
        ...
        input_ids_length = torch.tensor(len_texts, dtype=torch.long)
        ...
        return input_ids, input_ids_length, attention_mask, target_ids, clean_texts